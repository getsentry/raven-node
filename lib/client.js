...
Client.prototype.getIdent =
Client.prototype.get_ident = function getIdent(result) {
...
Client.prototype.captureError =
Client.prototype.captureException = function captureError(err, kwargs, cb) {
    var self = this;
    if(!cb && typeof kwargs === 'function') {
        cb = kwargs;
        kwargs = {};
